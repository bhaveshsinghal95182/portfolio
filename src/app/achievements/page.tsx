  ...
  return (
    <div>
      ...
      <p className="font-poppins text-muted-black text-sm pt-4">
        This is just a little page to talk about my own personal achievements I
        have made throughout my journey.
      </p>
      ...
      <ul className="list-disc pl-5 pt-6 space-y-0.5">
        ...
        <li className="font-poppins text-muted-black text-sm">
          Contributed to <span className="font-bold">open-source</span> projects
          on GitHub.
        </li>
      </ul>
    </div>
